# ABM_v3 implements the model capability for a vaccine
# -------------------------------- Functions -----------------------------------

AgentGen1 <- function(nPop1, E0, I0, vaccine = NA, social_distancing = NA){                                           # population size, n_exposed, n_infected
  ...
  if (!is.na(social_distancing$prevalence)) {
...
par1 <- data.frame(MaxMix = 7, 
                   S2E = 0.10,  # Probability an agent moves from susceptible to exposed
